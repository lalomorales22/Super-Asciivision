...
echo "     1. Open Settings and paste your xAI API key."
echo "     2. Click the ASCIIVISION button in the nav bar to launch ASCIIVision."
echo ""
echo "   Music: Drop audio files into ~/Music/SuperASCIIVision/ or use the"
echo "          Music page to import files and create playlists."
echo ""
echo "   Hands (mobile bridge): Works on local WiFi with zero setup."
echo "          For remote access, deploy a relay — see hands-relay/README.md."
echo ""
